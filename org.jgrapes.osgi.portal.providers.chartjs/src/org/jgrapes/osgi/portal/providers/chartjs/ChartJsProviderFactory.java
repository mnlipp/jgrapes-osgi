...
package org.jgrapes.osgi.portal.providers.chartjs;
...
public class ChartJsProviderFactory 
	implements PageResourceProviderFactory<ChartJsProvider> {

	/* (non-Javadoc)
	 * @see org.jgrapes.core.ComponentFactory#componentType()
	 */
	@Override
	public Class<ChartJsProvider> componentType() {
		return ChartJsProvider.class;
	}
	 ...
	 */
	@Override
	public ChartJsProvider create(Channel componentChannel,
	        Map<Object, Object> properties) {
		return new ChartJsProvider(componentChannel);
	}
