...
package org.jgrapes.osgi.portlets.markdowndisplay;
...
/**
 * The factory service for {@link MarkdownDisplayPortlet}s.
 */
@org.osgi.service.component.annotations.Component(scope=ServiceScope.SINGLETON)
public class MarkdownDisplayPortletFactory 
	implements PortletFactory<MarkdownDisplayPortlet> {

	/* (non-Javadoc)
	 * @see org.jgrapes.core.ComponentFactory#componentType()
	 */
	@Override
	public Class<MarkdownDisplayPortlet> componentType() {
	 ...
	 */
	@Override
	public MarkdownDisplayPortlet create(Channel componentChannel,
	        Map<Object, Object> properties) {
		return new MarkdownDisplayPortlet(componentChannel);
	}
